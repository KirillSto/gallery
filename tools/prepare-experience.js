...
console.log(`Issie.json info: exp=${issueExperience}, title=${issueTitle}, scr=${issueScreenshot}, desc=${issueDescription}, cat=${issueCategories}, lang=${issueLanguage}, auth=${issueAuthor}, name=${name}, id=${id}`)
